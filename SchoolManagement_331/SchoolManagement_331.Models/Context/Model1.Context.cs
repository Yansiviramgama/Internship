...
namespace SchoolManagement_331.Models.Context
{
    ...
    public partial class SchoolManagement_YV331Entities : DbContext
    {
        public SchoolManagement_YV331Entities()
            : base("name=SchoolManagement_YV331Entities")
        {
        }
        ...
        public virtual DbSet<TableCouponCodeMaster> TableCouponCodeMaster { get; set; }
        public virtual DbSet<TableItemMaster> TableItemMaster { get; set; }
        public virtual DbSet<UserOrder> UserOrder { get; set; }
    
        public virtual ObjectResult<GETALLSTATES_Result> GETALLSTATES()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GETALLSTATES_Result>("GETALLSTATES");
        }
        ...
        public virtual int Sp_AddEdit_Data(Nullable<int> iD, string firstName, string lastName, string email, string contactNumber, Nullable<System.DateTime> birthDate, string gender, string aDDRESS, Nullable<int> country, Nullable<int> state, Nullable<int> city, Nullable<int> postalCode)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_AddEdit_Data", iDParameter, firstNameParameter, lastNameParameter, emailParameter, contactNumberParameter, birthDateParameter, genderParameter, aDDRESSParameter, countryParameter, stateParameter, cityParameter, postalCodeParameter);
        }
        ...
        public virtual int Sp_Delete_Data(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_Delete_Data", iDParameter);
        }
        ...
        public virtual ObjectResult<GET_ITEM_BY_USERID_Result> GET_ITEM_BY_USERID(Nullable<int> uSERID)
        {
            var uSERIDParameter = uSERID.HasValue ?
                new ObjectParameter("USERID", uSERID) :
                new ObjectParameter("USERID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GET_ITEM_BY_USERID_Result>("GET_ITEM_BY_USERID", uSERIDParameter);
        }
    }
}
